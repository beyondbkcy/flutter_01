...
class _SplashState extends State<Splash> with SingleTickerProviderStateMixin {
  ...
  void _handleTap(TapUpDetails tapDetails) {
    ...
    radiusTween.end = constraintRadius * 0.5;
    borderWidthTween.begin = radiusTween.end / 5;
    borderWidthTween.end = radiusTween.end * 0;
    _animate();
